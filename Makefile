.PHONY: device-collector-infra-up device-collector-infra-check device-collector-app-test device-collector-app-run help
.PHONY: events-collector-infra-up events-collector-infra-check events-collector-app-test events-collector-app-run help
